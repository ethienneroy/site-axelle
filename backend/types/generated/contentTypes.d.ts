...
export interface ApiGlobalGlobal extends Schema.SingleType {
  ...
  attributes: {
    ...
    businessInformations: Attribute.Component<'elements.contact-informations'> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiReservationReservation extends Schema.CollectionType {
  ...
  attributes: {
    ...
    note: Attribute.Text & Attribute.Private;
    finished: Attribute.Boolean & Attribute.DefaultTo<false>;
    phone: Attribute.String;
    confirmed: Attribute.Boolean & Attribute.DefaultTo<false>;
    receipt: Attribute.Media & Attribute.Private;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::reservation.reservation',
